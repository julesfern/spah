/**
 * class Spah.SpahQL.Token.ComparisonOperator < Spah.SpahQL.Token.Simple
 *
 ...
 **/
  ...
  jQuery.extend(Spah.SpahQL.Token.ComparisonOperator, Spah.SpahQL.Token.Simple, {
    ...
    /**
     * Spah.SpahQL.Token.ComparisonOperator.parseAt(i, query) -> Array\[resumeIndex, foundToken\] or null
     *
