...
Spah.classExtend("Spah.SpahQL.Token.PathComponent", Spah.SpahQL.Token.Base, {
    ...
    /**
     * Spah.SpahQL.Token.PathComponent#evaluate(rootData, scopeData, path) -> Array of QueryResults
    ...
    "evaluate": function(rootData, scopeData, path) {
      ...
      if(this.key == null && this.property == null) {
        ...
        results = this.fetchResultsFromObjectByKey(keyName, scopeData, scopePath, this.recursive);
      }
      else if(this.property != null) {
        // Property query
        var propertyName = this.property.value;
        results = this.fetchResultsFromObjectByProperty(propertyName, scopeData, scopePath, this.recursive);
      }
    ...
    /**
     * Spah.SpahQL.Token.PathComponent#fetchResultsFromObjectByKey(key, object, path, recursive) -> Array of QueryResults
    ...
    /**
     * Spah.SpahQL.Token.PathComponent#fetchResultsFromObjectByProperty(key, object, path, recursive) -> Array of QueryResults
     * - key (String): The key to be retrieved from the object. Numeric keys in string formare acceptable when accessing arrays.
     * - object (Object): The data structure from which the key's associated value will be retrieved
     * - path (String): The path at which the item used as the 'object' argument is located
     * - recursive (Boolean): A flag indicating whether the key should also be pulled from any child objects of the given object. I N C E P T I O N.
