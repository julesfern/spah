 ...
 **/
  ...
  // Define and export
  Spah.SpahQL.Token.Boolean = function(value) { this.init(value) };
  window["Spah"]["SpahQL"]["Token"]["Boolean"] = Spah.SpahQL.Token.Boolean;
  
  // Singletons
  jQuery.extend(Spah.SpahQL.Token.Boolean, Spah.SpahQL.Token.Simple, {
  ...
  // Instance methods
  jQuery.extend(Spah.SpahQL.Token.Boolean.prototype, Spah.SpahQL.Token.Simple.prototype, {
